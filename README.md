...
- A service that lists football teams,

- Listing players of a team with the team ID,

- Deleting and updating a team with its ID,

- Adding players to a team and deleting them.

Rules:

- Each team can have 18 football players in total,

- Each team can have 6 foreign players at most,

- Each team can have 2 goalkeepers at most.
...
- [x] Swagger
- [x] Postman
- [x] JUnit and Mockito (Unit Testing just to practice on only one service)
